\documentclass[BCOR=0.8cm,headsepline,toc=listof,bibliography=totocnumbered,toc=index,bibliography=oldstyle,parskip,footnotes=multiple,numbers=noendperiod,DIV=11]{scrbook}
...
\usepackage{tabularx}  % variable sized tables
